...
existing node as a child node.
   ...
   fisrt.insertAfter(li , fisrt.firstElemen tChild) 
...
let listitemtwo = document.querySelector('li.collection-item:nth-child(2)')

let a = list
a =listitem
a= list.childNodes
// a =  
// a = list.childNodes[4].nodeName
// a = list.childNodes[4].nodeType
...
a = list.children// return html collection
a = list.firstChild//npde //return text
a = list.lastChild//node
a= list.firstElementChild // return element
a = list.lastElementChild
a = list.children
a= list.children[0]
list.children[4].textContent = 'LAST CHILD'

// parent
parent node return parent but
...
a= listitem.parentNode.parentNode
a= listitem.parentElement.parentElement

//sibling

nextSibling returns the next node (an element node, a text node or a comment node). nextElementSibling returns the next element (not text and comment nodes).

a = listitem.nextSibling.nextSibling
a= listitem.nextElementSibling.nextElementSibling
a =listitem.nextElementSibling.nextElementSibling.style.fontSize='25px'
a= listitemtwo.previousSibling
a= listitemtwo.previousElementSibling.previousElementSibling
...
// let btn = document.querySelector('.clear-tasks')
// console.log(btn);

// // btn.addEventListener('click', one)
// // btn.addEventListener('dblclick', one)
// // btn.addEventListener('mousedown', one)
// // btn.addEventListener('mouseup', one)

// function one(event){
//     // console.log('CLICKED ONE Func');
// // console.log(event);
...
// card.addEventListener('click',one)
// card.addEventListener('mouseenter',one)
// card.addEventListener('mouseleave',one)
// card.addEventListener('mouseout',one)
// card.addEventListener('mousemove',one)
// card.addEventListener('mouseover',one)

function one(){
    // alert('CARD IS CLICKED')
    let colors = [ 'yellow','aqua','pink','peach','orange','green']
    let indexNum = Math.trunc( Math.random()*6 )
...
console.log( Math.random()*3 );// between 0 and 3
...
// // taskInput.addEventListener('submit',one)
...
//     console.log(taskInput.value= 'SUBMITTED');
